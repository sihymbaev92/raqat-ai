...
HARAM_RULES = {
    ...
    "blood": "қан құрамы",
    "қан": "қан",
    "свиной": "шошқа өнімі / доңыз",
    "свинячий": "шошқа өнімі / доңыз",
    "бекон": "шошқа өнімі (бекон)",
    "шпик": "доңыз майы / шпик",
    "шнапс": "алкоголь",
    "коньяк": "алкоголь",
    "абсент": "алкоголь",
    "медовуха": "алкоголь",
...
DOUBTFUL_RULES = {
    ...
    "ветчина": "шұжық/ветчина — көбіне доңыз, тегі нақтылануы керек",
    "сало": "көбіне доңыз майы; тегі нақтылануы керек",
    "wine vinegar": "шарап сірке суы — өңдеу мен мөлшері нақтылануы керек",
    "уксус винный": "шарап сірке суы",
    "уксус из вина": "шарап сірке суы",
    "e422": "глицерин тегі (өсімдік/жануар)",
    "glycerol": "глицерин тегі",
    "глицерол": "глицерин тегі",
    "e920": "L-цистеин тегі (микроб/жануар/түктер)",
    "cysteine": "цистеин тегі күмәнді",
    "цистеин": "цистеин тегі күмәнді",
    "l-cysteine": "цистеин тегі күмәнді",
    "e921": "цистеин туыстары — тегі",
    "e631": "дизоинозинат тегі (балық/ет)",
    "e635": "рибонуклеотидтер тегі",
    "animal fat": "жануар майы — түрі көрсетілмеген",
    "животный жир": "жануар майы тегі",
    "жануар майы": "қай жануар екені көрсетілмеген",
    "natural flavor": "дәмдеуіш толық құрамы көрсетілмеген",
    "натуральный ароматизатор": "дәмдеуіш толық құрамы көрсетілмеген",
    "starter culture": "бактериялық дәмдеу — тегі нақтылануы керек",
}
