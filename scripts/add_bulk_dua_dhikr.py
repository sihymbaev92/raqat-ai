...
def add_duas() -> None:
    ...
    templates = [
        ...
        ("اللَّهُمَّ ارْحَمْنَا", "Аллаһ тағалам, рхамна", "Аллаһ тағалам, бізге мейірім ет."),
        ("اللَّهُمَّ اهْدِنَا", "Аллаһ тағалам, һдина", "Аллаһ тағалам, бізді тура жолға сал."),
        ("رَبِّ زِدْنِي عِلْمًا", "Рабби зидни илмa", "Раббым, білімімді арттыр."),
        ("حَسْبُنَا اللَّهُ", "Хасбуналлаһ", "Бізге Аллаһ жеткілікті."),
        ("اللَّهُمَّ بَارِكْ لَنَا", "Аллаһ тағалам, барик лана", "Аллаһ тағалам, бізге береке бер."),
        ("رَبِّ يَسِّرْ", "Рабби яссир", "Раббым, ісімізді жеңілдет."),
        ("اللَّهُمَّ صَلِّ عَلَى مُحَمَّدٍ", "Аллаһ тағалам, салли аля Мухаммад", "Аллаһ тағалам, Пайғамбарға салауат ет."),
...
def add_dhikr() -> None:
    ...
    templates = [
        ...
        ("salat_ala_nabi", "اللَّهُمَّ صَلِّ عَلَى مُحَمَّدٍ", "Аллаһ тағалам, салли аля Мухаммад", "Пайғамбарға салауат."),
