...
NEW = [
    ...
    {"id": 61, "slug": "allahumma_antarabbi", "textAr": "اللَّهُمَّ أَنْتَ رَبِّي لَا إِلَهَ إِلَّا أَنْتَ خَلَقْتَنِي وَأَنَا عَبْدُكَ", "textKk": "Сәййидүл-истигфар (басы)", "translitKk": "Аллаһ тағалам, анта рабби ла илаһа илла анта…", "meaningKk": "Ұлы истигфардың басы — кешірім мен тәуелділік.", "defaultTarget": 10, "phaseRule": None},
    ...
    {"id": 64, "slug": "allahumma_lakal_hamd", "textAr": "اللَّهُمَّ رَبَّنَا لَكَ الْحَمْدُ", "textKk": "Аллаһ тағалам, ләкал хамд", "translitKk": "Аллаһ тағалам, раббана ләкал хамд", "meaningKk": "Раббымыз, мақтау Саған (сәжде/құттықтау сияқты контекст).", "defaultTarget": 30, "phaseRule": None},
    {"id": 65, "slug": "allahumma_barik_rizq", "textAr": "اللَّهُمَّ بَارِكْ لِي فِي رِزْقِي", "textKk": "Аллаһ тағалам, барик ли ризқи", "translitKk": "Аллаһ тағалам, барик ли фи ризқи", "meaningKk": "Аллаһ тағалам, ризығымда береке бер.", "defaultTarget": 50, "phaseRule": None},
    {"id": 66, "slug": "audhu_hamm_wal_hazan", "textAr": "اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْهَمِّ وَالْحَزَنِ", "textKk": "Аллаһ тағалам, а'узу бика минал-һамм", "translitKk": "Аллаһ тағалам, инни а'узу бика минал-һамми уал-һазан", "meaningKk": "Қайғы мен мазасыздықтан пана (дуа басы).", "defaultTarget": 30, "phaseRule": None},
    {"id": 67, "slug": "audhu_ajz_wal_kasal", "textAr": "اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْعَجْزِ وَالْكَسَلِ", "textKk": "Аллаһ тағалам, а'узу минал-'ажзи", "translitKk": "Аллаһ тағалам, а'узу бика минал-'ажзи уал-касал", "meaningKk": "Әлсіздік пен жалқаулықтан пана.", "defaultTarget": 30, "phaseRule": None},
    {"id": 68, "slug": "asaluka_ilman_nafia", "textAr": "اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْمًا نَافِعًا", "textKk": "Аллаһ тағалам, ас'alука 'илман нафи'а", "translitKk": "Аллаһ тағалам, ас'alука 'илман нафи'ан", "meaningKk": "Пайдалы білім сұрау (дуаның басы).", "defaultTarget": 40, "phaseRule": None},
    {"id": 69, "slug": "asaluka_alhuda", "textAr": "اللَّهُمَّ إِنِّي أَسْأَلُكَ الْهُدَى", "textKk": "Аллаһ тағалам, ас'alукал-һуда", "translitKk": "Аллаһ тағалам, ас'alукал-һуда", "meaningKk": "Түзу жол сұрау.", "defaultTarget": 40, "phaseRule": None},
    {"id": 70, "slug": "allahumma_afuww", "textAr": "اللَّهُمَّ إِنَّكَ عَفُوٌّ تُحِبُّ الْعَفْوَ فَاعْفُ عَنِّي", "textKk": "Аллаһ тағалам, иннака 'афуввун…", "translitKk": "Аллаһ тағалам, иннака 'афуввун туһиббул-'афва фа'фу 'анни", "meaningKk": "Қадір түні: кешірімдісің, кешірімді сүйесің, кешір (жиі дұға).", "defaultTarget": 10, "phaseRule": None},
    {"id": 71, "slug": "allahumma_nur_qalb", "textAr": "اللَّهُمَّ اجْعَلْ فِي قَلْبِي نُورًا", "textKk": "Аллаһ тағалам, ж'ал фи қалби нуран", "translitKk": "Аллаһ тағалам, ж'ал фи қалби нуран", "meaningKk": "Жүрегіме нұр сал (рухани жарық).", "defaultTarget": 30, "phaseRule": None},
    {"id": 72, "slug": "allahumma_afwa_afiya", "textAr": "اللَّهُمَّ إِنِّي أَسْأَلُكَ الْعَفْوَ وَالْعَافِيَةَ", "textKk": "Аллаһ тағалам, ас'alукал-'афва", "translitKk": "Аллаһ тағалам, ас'alукал-'афва уал-'афийа", "meaningKk": "Кешірім мен амандық сұрау.", "defaultTarget": 40, "phaseRule": None},
    {"id": 73, "slug": "allahumma_hasib_yasir", "textAr": "اللَّهُمَّ حَاسِبْنِي حِسَابًا يَسِيرًا", "textKk": "Аллаһ тағалам, ҳасибни ҳисабан йасиран", "translitKk": "Аллаһ тағалам, ҳасибни ҳисабан йасиран", "meaningKk": "Есебімді жеңіл ет (қайғысыз кездесу).", "defaultTarget": 30, "phaseRule": None},
    ...
    {"id": 78, "slug": "allahumma_salim_muslimin", "textAr": "اللَّهُمَّ أَسْلِمْ أَسْلِمْ", "textKk": "Аллаһ тағалам, әслим әслим", "translitKk": "Аллаһ тағалам, әслим әслим", "meaningKk": "Аллаһ тағалам, салаamat бер (қысқа жиі дұға).", "defaultTarget": 30, "phaseRule": None},
    {"id": 79, "slug": "allahumma_ftah_li", "textAr": "اللَّهُمَّ افْتَحْ لِي أَبْوَابَ رَحْمَتِكَ", "textKk": "Аллаһ тағалам, фтәх ли абwаба рахматик", "translitKk": "Аллаһ тағалам, фтаҳ ли абwаба рахматик", "meaningKk": "Мейірім есіктерін аш (намаз сәлемінен кейін жиі).", "defaultTarget": 20, "phaseRule": None},
    {"id": 80, "slug": "allahumma_inni_zalamtu", "textAr": "اللَّهُمَّ إِنِّي ظَلَمْتُ نَفْسِي ظُلْمًا كَثِيرًا", "textKk": "Аллаһ тағалам, инни заламту нафси", "translitKk": "Аллаһ тағалам, инни заламту нафси зulман касиран", "meaningKk": "Нәпсіме көп зұлымдық істедім (истигфар басы).", "defaultTarget": 10, "phaseRule": None},
    ...
    {"id": 82, "slug": "allahumma_rzuqni", "textAr": "اللَّهُمَّ ارْزُقْنِي حَلَالًا طَيِّبًا", "textKk": "Аллаһ тағалам, рзуқни ҳалалән таййибан", "translitKk": "Аллаһ тағалам, рзуқни ҳалалән таййибан", "meaningKk": "Таза халал ризық бер.", "defaultTarget": 50, "phaseRule": None},
    {"id": 83, "slug": "allahumma_qini_azab", "textAr": "اللَّهُمَّ قِنِي عَذَابَكَ يَوْمَ تَبْعَثُ عِبَادَكَ", "textKk": "Аллаһ тағалам, қини 'азабак", "translitKk": "Аллаһ тағалам, қини 'азабака йаwма таб'асу 'ибадак", "meaningKk": "Қиямет күні азабыңнан сақта (дуа басы).", "defaultTarget": 15, "phaseRule": None},
    ...
    {"id": 88, "slug": "allahumma_laka_sumtu", "textAr": "اللَّهُمَّ لَكَ صُمْتُ وَعَلَى رِزْقِكَ أَفْطَرْتُ", "textKk": "Аллаһ тағалам, ләка сумту", "translitKk": "Аллаһ тағалам, ләка сумту уа 'алә ризқика aftарту", "meaningKk": "Саған ораза ұстап, ризығыңмен аштым (ороза ашар).", "defaultTarget": 10, "phaseRule": None},
    ...
    {"id": 93, "slug": "allahumma_salli_muhammadin", "textAr": "اللَّهُمَّ صَلِّ عَلَى مُحَمَّدٍ", "textKk": "Аллаһ тағалам, салли 'алә Мухаммад", "translitKk": "Аллаһ тағалам, салли 'алә Мухаммадин", "meaningKk": "Аллаһ тағалам, Мұхаммедке сәләу ет (қысқа).", "defaultTarget": 100, "phaseRule": None},
    {"id": 94, "slug": "allahumma_ghfir_muslimin", "textAr": "اللَّهُمَّ اغْفِرْ لِلْمُسْلِمِينَ وَالْمُسْلِمَاتِ", "textKk": "Аллаһ тағалам, ғфир лил-муслимин", "translitKk": "Аллаһ тағалам, ғфир лил-муслимина уал-муслимат", "meaningKk": "Мұсылман ерлер мен әйелдерді кешір.", "defaultTarget": 20, "phaseRule": None},
