#!/usr/bin/env node
/** Regenerates hajjMuftyatPages.ts (CDN URIs, no bundled JPG requires). */
const fs = require("fs");
const path = require("path");

const out = path.join(__dirname, "..", "src", "content", "hajjMuftyatPages.ts");
const body = `/** Auto-generated — scan JPG CDN; мәтін: hajjMuftyatPageText.json. Regen: scripts/gen-hajj-muftyat-pages.cjs */
