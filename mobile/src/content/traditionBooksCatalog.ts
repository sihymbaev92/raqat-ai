    ...
    .map((author) => {
      ...
      return {
        ...
        contents: [
          ...
          "Қазақша мәтін, қысқа мағына және қолданыс идеясы",
        ...
        howToRead: [
          "Күніне бір-екі сөзді оқып, отбасында қысқа талқылау.",
...
const KAZAKH_WONDERFUL_BOOK_HIGHLIGHTS: TraditionBookEntry[] = [
  {
    ...
    howToRead: ["Күніне бір сөз оқып, отбасында талқылау.", "Түпнұсқа басылыммен салыстыру."],
  ...
  },
  {
    ...
    subtitle: "Отбасылық тәрбие · әдеп",
    badge: "өсиет",
    summary: "Ана әулетінің тәрбие сөзі: ізет, еңбек, сабыр, көрші мен үлкенге құрмет.",
    contents: ["Өсиет нақылдары", "Отбасылық талқылауға ыңғайлы", "Қысқа жолдар"],
    religionLink: "Отбасылық әдеп пен ислам әдебі үйлеседі; сенімге қайшы ырымнан сақтану керек.",
...
export const TRADITION_BOOKS: TraditionBookEntry[] = [
  {
    ...
    howToRead: [
      ...
      "Ғылыми салыстыру үшін қайта түпнұсқаны қараңыз.",
    ],
  ...
  },
  {
    ...
    religionLink: "Отбасылық әдеп — сүннет пен шариғаттың маңызды бөлігі; ырымдық сенімнен ажыратыңыз.",
    howToRead: [
  ...
  },
  {
    ...
    group: "faith",
    title: "Құран Кәрім",
    subtitle: "Мұсаф оқу · қазақша мағына · кітап беті",
    summary:
    ...
    contents: [
      ...
      "Мұсаф/скролл режимі, оқу баптамалары",
  ...
  },
  {
    ...
    religionLink: "Намаз — Исламның екінші тірегі; дәстүрдегі уақыт сақтау мәдениеті намазбен үйлеседі.",
  ...
  },
  {
    ...
    subtitle: "ҚМДБ · «Құран оқып-үйренейік!»",
    summary:
      "ҚМДБ «Тәжуид» оқулығы: харакаттар, мәдд, уақф және Құран оқу ережелері — тек тәжуид бөлімі.",
  ...
  },
  {
    ...
    contents: ["Хатим жоспары", "Күнделікті мөлшер", "Оқу прогрессі", "Мұсафтан жалғастыру"],
  ...
  },
  {
    ...
    religionLink: "Қажылық — Исламның бесінші тірегі; қазақ қоғамында да қасиетті сапар ретінде құрметтеледі.",
    howToRead: [
  ...
  },
  {
    ...
    group: "ait",
    title: "Құрбан айт",
    subtitle: "Намаз · құрбан · қазақы ізет",
    badge: "4 бағыт",
    summary:
