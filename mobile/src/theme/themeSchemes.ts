...
const SCHEMES: Record<ThemeSchemeId, SchemeDef> = {
  noir: {
    ...
    base: {
      ...
      accent: "#38B2AC",
      accentDark: "#2A8F8A",
      accentSurface: "rgba(56, 178, 172, 0.12)",
      accentSurfaceStrong: "rgba(56, 178, 172, 0.22)",
  ...
  light: {
    ...
    base: {
      ...
      accent: "#C9A227",
      accentDark: "#A8841A",
      accentSurface: "rgba(201, 162, 39, 0.1)",
      accentSurfaceStrong: "rgba(201, 162, 39, 0.16)",
