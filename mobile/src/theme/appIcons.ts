...
export const dashboardIcons = {
  ...
  tileHalal: "food-halal" as MciName,
  tileTajweed: "abjad-arabic" as MciName,
  tileHajj: "kaaba" as MciName,
...
export const hubIcons = {
  ...
  tajweed: "alphabetical-variant" as MciName,
  halal: "food-halal" as MciName,
  ai: "robot-happy-outline" as MciName,
  hajj: "kaaba" as MciName,
