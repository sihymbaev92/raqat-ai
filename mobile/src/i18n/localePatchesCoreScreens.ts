...
const qiblaRu: CorePatch["qibla"] = {
  ...
  hintAligned:
    "Стрелка направлена к Каабе. Держите телефон горизонтально — верхний край к Каабе. Металл и магнитные поля могут влиять на точность.",
...
const qiblaEn: CorePatch["qibla"] = {
  ...
  hintAligned:
    "Arrow points toward the Kaaba. Hold the phone flat — top edge toward the Kaaba. Metal and magnetic fields may affect accuracy.",
...
const qiblaKy: CorePatch["qibla"] = {
  ...
  hintAligned:
    "Көрсөткүч Каабага карайт. Телефонду жазык кармаңыз — үстүңкү кыры Каабага карасын. Металл жана магнит тактыкты өзгөртүшү мүмкүн.",
...
const qiblaUz: CorePatch["qibla"] = {
  ...
  hintAligned:
    "Ko'rsatkich Kaabaga qarab turadi. Telefonni tekis ushlang — yuqori qirrasi Kaabaga qarasin. Metall va magnit maydonlar aniqlikka ta'sir qilishi mumkin.",
...
const qiblaTr: CorePatch["qibla"] = {
  ...
  hintAligned:
    "Ok Kâbe'ye bakıyor. Telefonu yatay tutun — üst kenar Kâbe'ye dönük olsun. Metal ve manyetik alanlar doğruluğu etkileyebilir.",
...
const qiblaAr: CorePatch["qibla"] = {
  ...
  hintAligned:
    "السهم نحو الكعبة. أمسك الهاتف أفقياً — الحافة العلوية نحو الكعبة. المعادن والحقول المغناطيسية قد تؤثر على الدقة.",
