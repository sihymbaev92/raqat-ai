...
export const kk = {
  ...
  asma: {
    ...
    intro:
      "Әр есім: арабша жазылу, қазақша атау және мағынасы бір жолда (толық түсініктеме). Тізімді іздеу жолағымен сүзуге болады.",
  ...
  account: {
    ...
    signInApple: "Apple / iCloud арқылы кіру",
    oauthGoogleNotConfigured:
      "Google кіру үшін app.json extra ішінде Google OAuth client id толтырыңыз.",
  ...
  navigation: {
    ...
    contentHubSub:
      "Төменде: Құран, хадис, намаз, тәжуид, халал, AI, қажылық… Торда: «Бүгінгі аят» пен «Қауым дұғасы».",
  },
  dashboard: {
    ...
    dailyAyahCta: "Бүгінгі бір аят",
    dailyAyahCtaSub: "Күн сайын жаңартылатын таңдаулы аят",
    aiOneCta: "RAQAT AI көмекші",
  ...
  dailyAyah: {
    title: "Бүгінгі бір аят",
    loading: "Жүктелуде…",
    error: "Мәтін алынбады",
    openSurah: "Сүреге өту",
    refLabel: (surah: number, ayah: number) => `${surah}-сүре · ${ayah}-аят`,
    sourceHint:
      "Мағына: алдымен платформа API (дерекқор), содан қолданба кеші (офлайн бандл), қажет болса сыртқы араб көзі.",
    noKkHint:
      "Бұл аят үшін қазақша мағына әзір көрсетілмейді — толық сүре экранында жаңартуды немесе API дерегін тексеріңіз.",
    fallbackTranslationNote:
      "Қазақша жол базада толық емес — төменде басқа тілдегі мағына көрсетілуде.",
  },
  tasbih: {
  ...
  aiChat: {
    placeholder:
      "Намаз рүкіндері, ораза, зекет, Құран аяты, сүре оқу тәртібі, күнделікті дұға — нақты сұрақ жазыңыз…",
    send: "Жіберу",
    empty:
    ...
    configTitle: "Сервер теңшелмеген",
    configBody:
      "Платформа URL (EXPO_PUBLIC_RAQAT_API_BASE / extra.raqatApiBase) мен AI кілті (EXPO_PUBLIC_RAQAT_AI_SECRET) түбір .env немесе mobile/.env.production арқылы release APK-ға енеді; қайта жинап орнатыңыз. EXPO_PUBLIC_RAQAT_AI_SECRET мән сервердегі RAQAT_AI_PROXY_SECRET-пен бірдей болуы керек. Телефоннан қолжетімді желі мекенжайын қолданыңыз (localhost емес). Өндірісте nginx арқылы HTTPS ұсынылады; HTTP IP үшін қолданбада cleartext рұқсаты бар.",
    ...
    usageTips:
      "Қалай сұрауға болады: «Фаджрдан кейінгі сүннет неше рәкәт?», «Зекет мөлшері қалай?», «Бұл аяттың қысқаша мағынасы». Күрделі жағдайда мәзһаб атаңыз; модель дерекқордағы аят/хадиске басым береді.",
  },
  features: {
    hatimTitle: "Хатым",
    hajjTitle: "Қажылық",
  ...
  settings: {
    ...
    accountOAuthHint:
      "Тікелей байланыс: Gmail (Google) және Apple ID (iCloud). Алдымен платформа API мекенжайы қосылған болуы керек.",
