...
export const kk = {
  ...
  tajweedGuide: {
    ...
    screenTitle: "Тәжуид",
    intro:
      "Тәжуид — әріпті дұрыс шығару, мәдд, идғам, уақф сияқты ережелермен Құранды оқу. Төмендегі рет: әріп кестесі → қысқаша ережелер → апта жоспары. Бұл бөлім толық оқулық емес; нақты дыбыс, ұзындық және мәзһабтық ерекшеліктерді мұғалім немесе маман кітаппен растаңыз.",
