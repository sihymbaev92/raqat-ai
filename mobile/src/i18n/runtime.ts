...
const LOCALE_PATCHES: Record<Exclude<AppLocale, "kk">, LocalePatch<typeof kk>> = {
  ...
  en: {
    ...
    settings: {
      ...
      feedbackPhoneSub: "Questions or suggestions — call us.",
  ...
  ky: {
    ...
    settings: {
      ...
      sectionFeedback: "Кайра байланыш", feedbackPhoneSub: "Суроо же сунуш — телефон аркылуу байланышыңыз.", sectionSupport: "Колдоо", headerSettingsA11y: "Жөндөөлөр",
  ...
  uz: {
    ...
    settings: {
      ...
      sectionFeedback: "Fikr-mulohaza", feedbackPhoneSub: "Savol yoki taklif — telefon orqali bog'laning.", sectionSupport: "Qo'llab-quvvatlash", headerSettingsA11y: "Sozlamalar",
  ...
  tr: {
    ...
    settings: {
      ...
      sectionFeedback: "Geri bildirim", feedbackPhoneSub: "Soru veya öneri — telefonla arayın.", sectionSupport: "Destek", headerSettingsA11y: "Ayarlar",
  ...
  ar: {
    ...
    settings: {
      ...
      sectionFeedback: "الملاحظات", feedbackPhoneSub: "سؤال أو اقتراح — اتصل بالهاتف.", sectionSupport: "الدعم", headerSettingsA11y: "الإعدادات",
