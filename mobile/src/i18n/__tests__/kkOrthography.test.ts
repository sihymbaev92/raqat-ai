...
const FORBIDDEN_UI_PATTERNS: Array<{ re: RegExp; hint: string }> = [
  ...
  { re: /арап жолдары/g, hint: "use «араб жолдары»" },
  { re: /үздіксін/g, hint: "use «үздіксіз»" },
  { re: /ысырақ/g, hint: "use «ысырап»" },
  { re: /Қыбла|қыблаға/g, hint: "use «Құбыла» / «құбылаға»" },
  { re: /қариы/g, hint: "use «қариі»" },
  { re: /Алла ол отынымен/g, hint: "use «Алла оған разы болсын»" },
