...
type Props = {
  ...
  aligned?: boolean;
  /** Сақина сыртқы қабық (halo+шеңбер) — әдепкі өшікті (компас сақинасы жоқ) */
  ...
  needlePulse?: boolean;
  /** Құбылаға турағанда төменгі жасыл «шам» пульсі — әдепкі өшікті */
  showAlignLed?: boolean;
  /** Диаль ортасындағы пивот нүктесі — әдепкі өшікті (тек оюлы иін көрінеді). */
